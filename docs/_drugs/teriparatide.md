...
Teriparatide currently has no marketing authorization on record in this dataset (`market_status: Not marketed`, `total_licenses: 0`). No license entries are available to summarize.
