...
import pandas as pd
from satxgnn.collectors import DrugBundleAggregator
from satxgnn.paths import get_bundles_dir, slugify
...
def preload_predictions(min_score: float = 0.99, top_n: int = 10) -> dict[str, list]:
    ...
    """
    from satxgnn.collectors.drug_bundle import PredictedIndication
